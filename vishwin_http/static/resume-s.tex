...
\textbf{Wahgwan Industry Limited} \textit{Owner} & November~2016\textendash present
\end{tabu}
\begin{itemize*}
\item Independent technical consulting, architecturing, development and presentations
\item Presented a talk overviewing nftables, the new Linux firewall and packet filter, at Philadelphia Linux Users Group in December~2016 and January~2017
\end{itemize*}
